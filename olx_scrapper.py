...
def build_url(filters):
    ...
    url = f"{base_url}search%5Border%5D=created_at:desc&search%5Bfilter_float_price:from%5D={price_min}&search%5Bfilter_float_price:to%5D={price_max}&search%5Bfilter_float_m:from%5D={area_min}&search%5Bfilter_float_m:to%5D={area_max}"
    return url
